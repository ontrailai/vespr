    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div 
          ...
          style={{ 
            background: `radial-gradient(ellipse at 70% 50%, ${currentIndustry.color}20 0%, transparent 50%)` 
          }}
        />
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center mb-16">
          <span 
            className={`inline-block text-[#D97756] font-semibold mb-4 tracking-widest uppercase text-xs transition-all duration-500 ${
          ...
          <h2 
            className={`font-serif text-4xl font-medium tracking-tight text-white sm:text-5xl lg:text-6xl leading-[1.1] transition-all duration-500 delay-100 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
            }`}
          >
          ...
          <p 
            className={`mt-6 text-lg leading-relaxed text-white/60 max-w-xl mx-auto transition-all duration-500 delay-200 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
            }`}
          >
        ...
        >
              ...
              return (
                ...
                >
                  <div 
                    ...
                    style={{ 
                      backgroundColor: isActive ? `${industry.color}30` : 'rgba(255,255,255,0.05)',
                    }}
                  >
                    <Icon 
                      className="h-6 w-6 transition-colors duration-300" 
                      style={{ color: isActive ? industry.color : 'rgba(255,255,255,0.4)' }}
                    />
                  </div>
          ...
          <div className="relative">
            <div 
              className="relative p-8 lg:p-10 rounded-3xl border border-white/10 overflow-hidden"
              style={{ backgroundColor: 'rgba(255,255,255,0.03)' }}
            >
              {/* Background icon */}
              <CurrentIcon 
                className="absolute -bottom-8 -right-8 h-48 w-48 transition-all duration-500"
                style={{ color: `${currentIndustry.color}10` }}
              />
              ...
              <div className="relative">
                <div 
                  ...
                  style={{ 
                    backgroundColor: `${currentIndustry.color}20`,
        ...
        >
          <div className="relative inline-block">
            ...
            <div className="absolute -inset-[1px] rounded-2xl bg-gradient-to-r from-[#D97756] via-[#4A9B94] to-[#8B6DB3] opacity-50 blur-sm" />
            
            <div className="relative bg-[#1a1816] rounded-2xl p-8 lg:p-10 border border-white/10">
              <div className="flex items-center justify-center gap-2 mb-4">
                <Sparkles className="h-5 w-5 text-[#D97756]" />
                <span className="text-white/60 text-sm font-medium uppercase tracking-wider">Your Industry</span>
                <Sparkles className="h-5 w-5 text-[#4A9B94]" />
              </div>
              ...
              <Button 
                size="lg" 
                asChild 
                className="group gap-2 bg-white hover:bg-white/90 text-[#1a1816] rounded-full px-8 h-12 text-base font-semibold transition-all hover:-translate-y-0.5"
              >
                <Link href="#pricing">
